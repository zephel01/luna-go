...
//  3. memory store experience.md  (implicit knowledge, auto-generated by `luna dream`)
//  4. ~/.luna-go/context.md       (global fallback)
//
// Sources 1, 2, and 3 are combined if they exist.
func loadContextFile(store *memory.Store) string {
	...
	// 3. Implicit knowledge / experience (auto-generated by `luna dream`)
	if store != nil {
		if exp, err := store.ReadExperience(); err == nil && exp != "" {
			fmt.Fprintf(os.Stderr, "✨ loaded memory/experience.md (%s)\n", store.Project)
			parts = append(parts, "## Experience\n"+exp)
		}
	}
